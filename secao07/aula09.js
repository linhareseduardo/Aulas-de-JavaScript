...
const f1 = new Funcionario('Paula', 'Fernandes', 'paula@gmail.com', '819.345.123.55', prog, 'F9883df');

const c1 = new Cliente('Pedro',' Silveira', 'pedro@gmail.com','903.244.22.34', 456669.09);
